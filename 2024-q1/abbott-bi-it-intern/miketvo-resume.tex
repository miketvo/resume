...
\section{Skills}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Technologies}
      {Scikit-learn, Tensorflow, Keras, Pandas, React, NextJS, Vite, Express, MongoDB, MySQL}
    \resumeSubItem{Tools}
      {Git, Vim, Visual Studio Code, Jupyter Lab, Jupyter Notebook, Jetbrains IDEs, Linux, Jira, Excel, Tableau}
  \resumeSubHeadingListEnd
%
