...
\section{Dự Án}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Imdupes}{}
      {Công cụ lọc hình ảnh trùng lặp mã nguồn mở, ý tưởng dựa trên GNU fdupes $|$ \href{https://github.com/miketvo/imdupes}{\faGithub\space miketvo/imdupes}}{}
      \resumeItemListStart
        \resumeItem{Ngôn ngữ và Framework}
...
\p{Cảm ơn công ty đã dành thời gian xem xét đơn ứng tuyển của tôi. Tôi mong sẽ có cơ hội được đóng góp và học hỏi tại Kegmil Việt Nam.}
