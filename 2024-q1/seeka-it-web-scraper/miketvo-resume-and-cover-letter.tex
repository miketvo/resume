...
\section{Skills}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Technologies}
      {BeautifulSoup, Pandas, Tensorflow, Keras, Scikit-Learn, FastAPI, NodeJS, React, MySQL, MongoDB}
    \resumeSubItem{Tools}
      {Jira, Git, Vim, VS Code, Postman, Linux, Jupyter Lab/Notebook, PyCharm, Adobe XD, Adobe Illustrator}
